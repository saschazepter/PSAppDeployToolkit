...
namespace PSADT.Module
{
    ...
    internal static class AssemblyPermissions
    {
        ...
        /// </summary>
        private static readonly ImmutableArray<FileInfo> _assemblies = [.. Directory.GetFiles(Path.GetDirectoryName(typeof(AssemblyPermissions).Assembly.Location)!, "*", SearchOption.AllDirectories).Select(static f => new FileInfo(f))];
    }
}
